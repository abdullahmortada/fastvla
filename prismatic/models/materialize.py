...
from prismatic.models.backbones.llm import LLaMa2LLMBackbone, LLMBackbone, MistralLLMBackbone, PhiLLMBackbone, GPT2LLMBackbone
...
LLM_BACKBONES = {
    ...
    # === GPT2 Backbone ===
    "distilgpt2": {"cls": GPT2LLMBackbone, "kwargs": {}},
}
